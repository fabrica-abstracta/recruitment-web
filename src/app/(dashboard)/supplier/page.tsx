    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          <a href="/supplier/profiles" className="bg-white rounded-lg shadow hover:shadow-lg transition p-6 block">
          ...
          <a href="/supplier/job-positions" className="bg-white rounded-lg shadow hover:shadow-lg transition p-6 block">
            <div className="text-center">
          ...
          <a href="/supplier/placements" className="bg-white rounded-lg shadow hover:shadow-lg transition p-6 block">
            <div className="text-center">
          ...
          <a href="/supplier/commissions" className="bg-white rounded-lg shadow hover:shadow-lg transition p-6 block">
            <div className="text-center">
          ...
          <a href="/supplier/dashboard" className="bg-white rounded-lg shadow hover:shadow-lg transition p-6 block">
            <div className="text-center">
              <i className="fas fa-chart-bar text-3xl text-red-600 mb-4"></i>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Dashboard Extendido</h3>
              <p className="text-gray-600 text-sm">Métricas detalladas</p>
            </div>
          </a>
        </div>
