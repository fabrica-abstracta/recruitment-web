    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <a href="/customer/job-positions" className="bg-white rounded-lg shadow hover:shadow-lg transition p-6 block">
          ...
          <a href="/customer/contracts" className="bg-white rounded-lg shadow hover:shadow-lg transition p-6 block">
            <div className="text-center">
          ...
          <a href="/customer/placements" className="bg-white rounded-lg shadow hover:shadow-lg transition p-6 block">
            <div className="text-center">
          ...
          <a href="/customer/dashboard" className="bg-white rounded-lg shadow hover:shadow-lg transition p-6 block">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Métricas y reportes detallados</p>
            </div>
          </a>
        </div>
